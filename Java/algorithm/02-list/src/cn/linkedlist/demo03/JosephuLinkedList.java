...
// 约瑟夫环实现
public class JosephuLinkedList<E> implements List<E> {
    // 创建Node节点
    private class Node{
        //数据域 用来存储数据的
        public E data;
    ...
    // 初始化链表
    public JosephuLinkedList(){
        head = null;
        tail = null;
        size = 0;
    }

    public JosephuLinkedList(E[] arr){
        for (E e : arr){
            add(e);
        }
    }
    ...
    public Iterator<E> iterator() {
        return new JosephuLinkedListIterator();
    }

    class JosephuLinkedListIterator implements Iterator<E>{
        // 定义游标
